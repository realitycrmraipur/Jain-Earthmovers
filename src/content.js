...
export const equipment = {
  ...
  categories: [
    {
      id: 'sany-140',
      name: 'SANY SY140 Hydraulic Excavator',
      type: 'Hydraulic Excavator',
      badge: '14-Tonne Class',
      image: './equipment/sany-sy140.jpg',
      tagline: 'SY140C-9S Quarry — agile 14-tonne digging power for earthwork and site development.',
      // Official specs: sany.in SY140C-9S Quarry product page + brochure (Mar 2025)
      specs: [
        { label: 'Operating Weight', value: '14,030 kg' },
        { label: 'Engine Power', value: '100.5 hp (75 kW)' },
        { label: 'Bucket Capacity', value: '0.72 m³' },
        { label: 'Max Digging Depth', value: '5,119 mm' },
        { label: 'Max Digging Reach', value: '7,952 mm' },
        { label: 'Fuel Tank', value: '240 L' },
      ],
      features: ['Fuel-efficient hydraulics', 'Operator-comfort cab', 'Reinforced undercarriage', 'Quick-couple attachments'],
    },
    {
      id: 'sany-210',
      name: 'SANY SY210 Hydraulic Excavator',
      type: 'Hydraulic Excavator',
      badge: '21-Tonne Class',
      image: './equipment/sany-sy210.jpg',
      tagline: 'SY210C-9 SPARC+ — high-output 21-tonne class for bulk excavation and overburden.',
      // Official specs: sany.in SY210C-9 SPARC+ product page + brochure (Apr 2025); std 2.4 m arm
      specs: [
        { label: 'Operating Weight', value: '20,900 kg' },
        { label: 'Engine Power', value: '140 hp (104 kW)' },
        { label: 'Bucket Capacity', value: '1.1 m³ (GP)' },
        { label: 'Max Digging Depth', value: '6,037 mm' },
        { label: 'Max Digging Reach', value: '9,312 mm' },
        { label: 'Fuel Tank', value: '340 L' },
      ],
      features: ['Heavy-duty boom & stick', 'High-flow hydraulics', 'Auto idle fuel saving', 'All-terrain undercarriage'],
    },
    {
      id: 'hyundai-215',
      name: 'Hyundai 215 Hydraulic Excavator',
      type: 'Hydraulic Excavator',
      badge: '21.5-Tonne Class',
      image: './equipment/hyundai-215.jpg',
      tagline: 'R215 Smart X Plus — proven 21.5-tonne workhorse for sustained heavy excavation.',
      // Official specs: in.hd-hyundaice.com R215 Smart X Plus product page + brochure; std 2.4 m arm
      specs: [
        { label: 'Operating Weight', value: '21,700 kg' },
        { label: 'Engine Power', value: '140 hp (104 kW)' },
        { label: 'Bucket Capacity', value: '0.92–1.5 m³' },
        { label: 'Max Digging Depth', value: '6,236 mm' },
        { label: 'Max Digging Reach', value: '9,311 mm' },
        { label: 'Fuel Tank', value: '340 L' },
      ],
      features: ['Precision hydraulics', 'Low-fuel ECO modes', 'Spacious ROPS cab', 'Strong breakout force'],
    },
    {
      id: 'ajax-argo-4300',
      name: 'Ajax ARGO 4300',
      ...
      specs: [
        ...
        { label: 'Engine Power', value: '110 hp (80.9 kW)' },
        { label: 'Drive', value: '4-Wheel Drive' },
        { label: 'Water Tank', value: '800 L' },
        { label: 'Fuel Tank', value: '115 L' },
        { label: 'Unladen Weight', value: '8,290 kg' },
      ],
      features: ['Self-loading hopper', 'Weigh-batching system', 'All-terrain 4WD', 'Consistent batch control'],
    },
    {
      id: 'ajax-argo-4500',
      name: 'Ajax ARGO 4500',
      type: 'Self-Loading Concrete Mixer',
      badge: '4.5 m³ Batch',
      image: './equipment/ajax-argo-4500.jpg',
      tagline: 'Higher-volume self-loading mixer for sustained pours.',
      // Official specs: ajax-engg.com ARGO 4500 SLCM page + CEV Stage-V brochure (July 2025)
      specs: [
        { label: 'Output per Batch', value: '4.5 m³' },
        { label: 'Engine Power', value: '81–101.5 kW (CEV V)' },
        { label: 'Drive', value: 'Full-time 4WD' },
        { label: 'Water Tank', value: '800 L' },
        { label: 'Fuel Tank', value: '135 L' },
        { label: 'Unladen Weight', value: '8,890 kg' },
      ],
