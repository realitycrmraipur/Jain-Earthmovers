  ...
  categories: [
    {
      ...
      tagline: 'Agile 14-tonne digging power for earthwork and site development.',
      specs: [
        { label: 'Operating Weight', value: '14 t' },
        { label: 'Engine Power', value: '~100 hp (74.5 kW)' },
        { label: 'Bucket Capacity', value: '0.6 m³' },
        { label: 'Max Digging Depth', value: '5.5 m' },
        { label: 'Max Reach', value: '8.3 m' },
    ...
    },
    {
      ...
      tagline: 'High-output 21-tonne class for bulk excavation and overburden.',
      specs: [
        { label: 'Operating Weight', value: '21 t' },
        { label: 'Engine Power', value: '~158 hp (118 kW)' },
        { label: 'Bucket Capacity', value: '1.0 m³' },
        { label: 'Max Digging Depth', value: '6.7 m' },
        { label: 'Max Reach', value: '9.9 m' },
    ...
    },
    {
      ...
      tagline: 'Proven 21.5-tonne workhorse for sustained heavy excavation.',
      specs: [
        { label: 'Operating Weight', value: '21.5 t' },
        { label: 'Engine Power', value: '~160 hp (119 kW)' },
        { label: 'Bucket Capacity', value: '1.05 m³' },
        { label: 'Max Digging Depth', value: '6.6 m' },
        { label: 'Max Reach', value: '9.9 m' },
        { label: 'Fuel Tank', value: '400 L' },
      ],
    ...
    },
    {
      ...
      specs: [
        ...
        { label: 'Mixing Output', value: '~17 m³/hr' },
        { label: 'Engine Power', value: '74 hp' },
        { label: 'Drive', value: '4WD self-loading' },
        { label: 'Drum Capacity', value: '6,120 L' },
    ...
    },
    {
      ...
      specs: [
        ...
        { label: 'Mixing Output', value: '~18 m³/hr' },
        { label: 'Engine Power', value: '90 hp' },
        { label: 'Drive', value: '4WD self-loading' },
        { label: 'Drum Capacity', value: '6,500 L' },
